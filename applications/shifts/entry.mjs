...
const backend=createAppBackend({timeoutMs:30_000,input:process.stdin,output:process.stdout,handlers:createShiftsHandlers({invoke:(...args)=>backend.gateway.invoke(...args)})});
