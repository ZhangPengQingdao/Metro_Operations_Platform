...
import {createMaterialsHandlers} from './handlers.mjs';
const backend=createAppBackend({input:process.stdin,output:process.stdout,handlers:createMaterialsHandlers({invoke:(...args)=>backend.gateway.invoke(...args)})});
