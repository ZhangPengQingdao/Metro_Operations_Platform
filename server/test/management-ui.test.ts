...
const manifest={id:'sample',name:'Sample',ui:{mode:'sandbox',entryArtifactId:'entry'},routes:[{path:'/'}],artifacts:[{id:'entry',bytes:Buffer.byteLength(script),sha256:createHash('sha256').update(script).digest('hex')}]};
