...
import { AppRuntimeWorkJournal, APP_RUNTIME_WORK_SQL } from '../src/app-platform/runtime/work-journal.ts';
...
async function fixture(){
 ...
 await db.exec('CREATE TABLE public.platform_app_installations(id uuid PRIMARY KEY);'+APP_RUNTIME_WORK_SQL);
