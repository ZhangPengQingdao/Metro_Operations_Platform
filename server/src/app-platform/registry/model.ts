...
export interface AppInstallationHistory {
  ...
  revision: number;
  action: 'registered' | 'enabled' | 'disabled' | 'grant-approved' | 'grant-revoked' | 'credential-issued' | 'credential-revoked' | 'lifecycle-started' | 'lifecycle-completed' | 'lifecycle-failed' | 'lifecycle-cancelled';
  lifecycle?: AppLifecycleOperation;
