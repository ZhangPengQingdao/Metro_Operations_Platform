...
export function createDirectoryGatewayOperations(options:{locations:Pick<LocationDirectoryRepository,'findLocationById'>;assets:Pick<AssetDirectoryRepository,'findAssetById'>;listLocations?:(input:z.infer<typeof locationListInput>)=>Promise<z.infer<typeof locationResult>[]>}):AppGatewayOperation[]{
