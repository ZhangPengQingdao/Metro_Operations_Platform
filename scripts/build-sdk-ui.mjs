...
export declare const FilterBar:ComponentType<{layout?:'compact'|'spread';searchValue?:string;onSearchChange?:(value:string)=>void;searchPlaceholder?:string;showDateRange?:boolean;rightAction?:ReactNode;filterGroups?:{id:string;title:string;options:{id:string;label:string}[];isMulti?:boolean;allowAll?:boolean}[];activeFilters?:{startDate?:string;endDate?:string;selectedOptions:Record<string,string[]>};onApplyFilters?:(filters:{startDate?:string;endDate?:string;selectedOptions:Record<string,string[]>})=>void;onResetFilters?:()=>void;showActiveTags?:boolean;onRemoveTag?:(groupId:string,optionId:string)=>void}>;
