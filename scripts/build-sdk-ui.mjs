...
export declare const Play:typeof PencilSimpleLine;
export declare const Pause:typeof PencilSimpleLine;
export declare const ArrowsClockwise:typeof PencilSimpleLine;
export declare const Eye:typeof PencilSimpleLine;
...
export declare function SearchSelect<T extends SearchSelectOption>(props:{id:string;value:string;options:readonly T[];onInput:(value:string)=>void;onSelect:(option:T)=>void;onSearch?:(value:string)=>void;placeholder:string;disabled?:boolean;required?:boolean;allowCustom?:boolean;emptyText?:string}):ReactNode;
export declare const DropdownSelect:ComponentType<{id?:string;value:string;onChange:(value:string)=>void;options:{value:string;label:string;disabled?:boolean}[];placeholder?:string;disabled?:boolean;ariaLabel?:string;className?:string}>;
...
export declare const TagDropdownPicker:ComponentType<{items:{id:string;label:string;group?:string;badge?:string|number;disabled?:boolean}[];selectedIds:string[];onChange:(ids:string[])=>void;title?:string;buttonText?:string;buttonVariant?:'primary'|'secondary'|'soft'|'ghost'|'outline';emptyText?:string;disabled?:boolean;multiple?:boolean;align?:'left'|'right';showTagsBelow?:boolean;inline?:boolean;className?:string}>;
